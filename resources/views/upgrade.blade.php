...
<section class="bg-white dark:bg-gray-900">
    <div class="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
        <div class="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Experience Chungus, but PRO.</h2>
            <p class="mb-4">Chungus is an advanced AI image generation platform that allows users to create stunning, high-quality visuals effortlessly. Upgrading to a subscription unlocks access to enhanced features such as higher-resolution outputs, advanced customization options, and faster processing times. Subscribers also receive priority support and exclusive updates, ensuring they stay at the cutting edge of image generation technology. Investing in a subscription provides a more powerful and versatile toolset for creating exceptional images tailored to your needs.</p>
        </div>
        <div class="grid grid-cols-2 gap-4 mt-8">
            <img class="w-full rounded-lg" src="https://i.scdn.co/image/ab67616d00001e02acc72f988f7dd901c77a717b" alt="office content 1">
            <img class="mt-4 w-full lg:mt-10 rounded-lg" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoHBx6pSUECIiITxYjehadhQZPoNyoiPzL0w&s" alt="office content 2">
        </div>
    </div>
</section>
<br><br>
...
<section class="bg-white dark:bg-gray-900">
  <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Designed for CHUNGUS like yours</h2>
          <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Here at Chungus we focus on markets where technology, innovation, and capital can unlock long-term value and drive economic growth.</p>
      </div>
